<?php 
// Template personalizado para pagamento com PIX
...
<head>
    ...
    <title>Pagamento via PIX - <?= htmlspecialchars($product['title']) ?></title>
...
<body>
    <div class="pix-container">
        ...
        <form action="<?= BASE_URL ?>/checkout/confirmPix/<?= $order['id'] ?>" method="POST" class="mt-4">
